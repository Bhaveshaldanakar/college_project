...
public class TamilNadu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageSlider imageSlider=findViewById(R.id.imageslider4);
...
// Create a Uri object with the location data
                Uri uri = Uri.parse("geo:0,0?q=Meenakshi Amman Temple, Madurai Main, Madurai, Tamil Nadu");
...
// Create a Uri object with the location data
                Uri uri = Uri.parse("geo:0,0?q=Membalam Rd, Balaganapathy Nagar, Thanjavur, Tamil Nadu 613007");
// Launch the Google Maps app with the Uri
                Intent intent = new Intent(Intent.ACTION_VIEW, uri);
                intent.setPackage("com.google.android.apps.maps");
                startActivity(intent);
...
// Create a Uri object with the location data
                Uri uri = Uri.parse("geo:0,0?q=Marina Beach, Triplicane, Chennai, Tamil Nadu");
// Launch the Google Maps app with the Uri
                Intent intent = new Intent(Intent.ACTION_VIEW, uri);
                intent.setPackage("com.google.android.apps.maps");
                startActivity(intent);
...
// Create a Uri object with the location data
                Uri uri = Uri.parse("geo:0,0?q=J58V+JWW, Beach Rd, Mahabalipuram, Tamil Nadu 603104");
// Launch the Google Maps app with the Uri
                Intent intent = new Intent(Intent.ACTION_VIEW, uri);
                intent.setPackage("com.google.android.apps.maps");
                startActivity(intent);
...
// Create a Uri object with the location data
                Uri uri = Uri.parse("geo:0,0?q=Government Museum Chennai, Government Maternity Hospital, Pantheon Road, Egmore, Chennai, Tamil Nadu");
// Launch the Google Maps app with the Uri
                Intent intent = new Intent(Intent.ACTION_VIEW, uri);
                intent.setPackage("com.google.android.apps.maps");
                startActivity(intent);
