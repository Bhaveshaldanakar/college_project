...
// Create a Uri object with the location data
                Uri uri = Uri.parse("geo:0,0?q=Chitrakote Waterfalls, Tiratha, Chhattisgarh");
...
// Create a Uri object with the location data
                Uri uri = Uri.parse("geo:0,0?q=624J+9G3, Dantewada, Chhattisgarh 494444");
// Launch the Google Maps app with the Uri
                Intent intent = new Intent(Intent.ACTION_VIEW, uri);
                intent.setPackage("com.google.android.apps.maps");
                startActivity(intent);
...
// Create a Uri object with the location data
                Uri uri = Uri.parse("geo:0,0?q=Kanger Valley National Park, Tirathgar, Chhattisgarh 494442");
// Launch the Google Maps app with the Uri
                Intent intent = new Intent(Intent.ACTION_VIEW, uri);
                intent.setPackage("com.google.android.apps.maps");
                startActivity(intent);
...
// Create a Uri object with the location data
                Uri uri = Uri.parse("geo:0,0?q= FG29+CCW, Gram Barnawapara, Sirpur Road, Kasdol, Chhattisgarh 493332");
// Launch the Google Maps app with the Uri
                Intent intent = new Intent(Intent.ACTION_VIEW, uri);
                intent.setPackage("com.google.android.apps.maps");
                startActivity(intent);
...
// Create a Uri object with the location data
                Uri uri = Uri.parse("geo:0,0?q=Kotumsar Cave,Bastar,Chhattisgarh 494001");
// Launch the Google Maps app with the Uri
                Intent intent = new Intent(Intent.ACTION_VIEW, uri);
                intent.setPackage("com.google.android.apps.maps");
                startActivity(intent);
